...
namespace sampleLiveChart2
{
    public class RJDatePicker : DateTimePicker
    {
        ...
        private const int arrowIconWidth = 0;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (StringFormat textFormat = new StringFormat())
            {
                ...
                if (droppedDown == true) _graphics.FillRectangle(openIconBrush, iconArea);
                //Draw border 
                if (borderSize >= 1) _graphics.DrawRectangle(penBorder, clientArea.X, clientArea.Y, clientArea.Width, clientArea.Height);
                //Draw icon
                _graphics.DrawImage(calendarIcon, this.Width - calendarIcon.Width - 9, (this.Height - calendarIcon.Height) / 2);
